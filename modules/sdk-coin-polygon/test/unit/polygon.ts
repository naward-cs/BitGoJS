...
describe('Polygon', function () {
  ...
  describe('Recover transaction:', function () {
    ...
    it('should construct an unsigned sweep tx with TSS', async function () {
      const backupKeyAddress = '0x568d1feb0a444a8e770f569143da3b2036c3ee45';
      nock(baseUrl)
        .get('/api')
        .query(mockData.getTxListRequest(backupKeyAddress))
        .reply(200, mockData.getTxListResponse);
      ...
      const userKey =
        '02fa3d17f00d258c07f3bcd46f4b35b08d6259048f65068f526e08d7765ad42c10373b54754de4183ad3bba6be1add81135f97ac528ba01fc0d99cf2ab8bdb56e7';
      const backupKey =
        '02fa3d17f00d258c07f3bcd46f4b35b08d6259048f65068f526e08d7765ad42c10373b54754de4183ad3bba6be1add81135f97ac528ba01fc0d99cf2ab8bdb56e7';
